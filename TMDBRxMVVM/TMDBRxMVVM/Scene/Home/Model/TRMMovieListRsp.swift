...
// MARK: - TRMMovieListRsp
class TRMMovieListRsp: Codable {
    let dates: TRMDates?
    let page: Int?
    let results: [TRMMovieListItem]?
    ...
    init(dates: TRMDates?, page: Int?, results: [TRMMovieListItem]?, totalPages: Int?, totalResults: Int?) {
        self.dates = dates
        self.page = page
...
// MARK: - Result
class TRMMovieListItem: Codable {
    let adult: Bool?
